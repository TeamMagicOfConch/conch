      ...
      <aside className="w-48 bg-white border-r border-black flex flex-col items-start">
        ...
        <div className="flex flex-col space-y-4 w-full p-4">
          <button
            ...
            className={`p-3 rounded-lg w-full flex items-center gap-3 ${location.pathname === '/decrypt' ? 'bg-black text-white' : 'hover:bg-black/5'}`}
          >
          ...
          <button
            ...
            className={`p-3 rounded-lg w-full flex items-center gap-3 ${location.pathname === '/download' ? 'bg-black text-white' : 'hover:bg-black/5'}`}
          >
