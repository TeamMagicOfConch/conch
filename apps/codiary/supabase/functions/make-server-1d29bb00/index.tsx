...
app.post('/make-server-1d29bb00/admin/session/reset', authMiddleware, adminMiddleware, async (c) => {
  try {
    ...
    console.log(`[ADMIN] session_reset preserved_users=${userKeys.length} preserved_matching=${matchingKeys.length} deleted=${sessionKeys.length}`)
    ...
    return c.json({
      ...
      preserved: {
        ...
        matchingConfig: matchingKeys.length,
      },
      deleted: {
